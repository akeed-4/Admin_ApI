...
namespace WaseetAPI.Domain.Models
{
    public class Admin
    {
        ...
        public class AuthenticateAdmin
        {
            ...
            public AuthenticateAdmin(Admin admin = null)
            {
                if (admin != null)
                {
        ...
        {
            public Admin user_data { get; set; }
            public string connection { get; set; }
            public bool status { get; set; }
            public Languages message { get; set; }
            public int error_code { get; set; }
            public AdminConnection(int response_user_id, string response_user_name, string response_user_image, string response_user_address, int response_user_online_type, int response_is_own_database, string response_connection, bool response_status, Languages response_message, int response_error_code)
            {
                user_data = new Admin()
                {
